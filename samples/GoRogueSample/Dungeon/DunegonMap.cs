...
namespace GoRogueSample.Dungeon
{
    ...
    class ExampleMap : BasicMap
    {
        ...
        // Since we'll want to access the player as our Player type, create a property to do the cast for us.
        // The cast must succeed thanks to the ControlledGameObjectTypeCheck implemented in the constructor.
